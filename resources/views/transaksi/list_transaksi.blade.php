...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="page-home.html" class="title-page">List Transaksi</a></div>
...
<div class="page-content-wrapper">
    ...
    <section id="list-transaksi-header">
        <div class="container">
            <div class="pb-3 pt-3">
                <input type="text" class="form-control" placeholder="Cari nama pelanggan, layanan ...">
            </div>
            <div class="transaksi-menu">
                <div class="minimal-tab">
                    <ul class="nav nav-tabs mb-3" id="affanTab2" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="btn menu-title" id="haha" data-bs-toggle="tab" data-bs-target="#pug" type="button" role="tab" aria-controls="pug" aria-selected="false">Diambil</button>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            @foreach($transaksi as $tra)
                                <div class="card card-transaksi">
                                    ...
                                    <div class="card-bottom-transaksi">
                                        <div class="row">
                                            <div class="col-5">
                                                <a class="btn btn-putih">Cetak Nota</a>
                                            </div>
                                            <div class="col-5">
