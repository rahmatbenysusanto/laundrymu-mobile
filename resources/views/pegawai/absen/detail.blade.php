...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Detail Absensi</a></div>
...
<div class="page-content-wrapper">
    ...
    <div class="container">
        <table class="w-100" id="listPegawai">
            ...
            <tbody>
            @foreach($absen[2] as $par)
                <tr>
                    <td>
                        <div class="card p-2 mb-3">
                            <p class="text-nama">Status : {{ $par->status }}</p>
                            <p class="text-harga">Tanggal : {{ tanggal_indo($par->tanggal) }}</p>
                            <p class="text-harga">Keterangan : {{ $par->keterangan ?? "-" }}</p>
                        </div>
                    </td>
                </tr>
            @endforeach
