...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Absensi Pegawai</a></div>
            <div class="user-profile-wrapper">
                <a href="{{ route('tambahAbsensi') }}" class="text-black">
...
<div class="page-content-wrapper">
    ...
    <div class="container">
        <table class="w-100" id="listPegawai">
            ...
            <tbody>
            @foreach($absenPegawai as $par)
                <tr>
                    <td>
                        <div class="card p-2 mb-3">
                            <p class="text-nama">{{ $par[0]->user->nama }}</p>
                            <p class="text-harga">{{ $par[0]->user->no_hp }}</p>
                            <p class="text-harga">Masuk Bulan {{ getBulan() }} : {{ $par[1] }}</p>
                            <div class="row mt-3">
                                <div class="col-12">
                                    <a href="/detail-absen-pegawai/{{ base64_encode($par[0]->user->id) }}" class="btn btn-putih">Detail</a>
                                </div>
                            </div>
                        </div>
                    </td>
