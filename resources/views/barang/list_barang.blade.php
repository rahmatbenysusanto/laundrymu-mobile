...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Daftar Barang</a></div>
...
<div class="page-content-wrapper">
    ...
    <div class="mt-3"></div>
    <div class="container">
        <table class="w-100" id="listBarang">
            <thead>
            <tr>
                <th></th>
            </tr>
                ...
                <tr>
                    <td>
                        <div class="card p-2 mb-3">
                            <p class="text-nama">{{ $bar->nama }}</p>
                            <p class="text-harga">Stok : {{ $bar->stok }}</p>
                        </div>
                    </td>
                </tr>
            @endforeach
