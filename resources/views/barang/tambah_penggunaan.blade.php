...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Tambah Penggunaan</a></div>
...
<div class="page-content-wrapper">
    ...
    <div class="container pt-3">
        <div class="row">
            <div class="col-12">
                <div class="card p-2">
                    <form action="{{ route('prosesPenggunaan') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="jumlah" type="number" placeholder="Masukan jumlah" name="stok" required>
                        </div>
                        <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="submit">Tambah Penggunaan</button>
                    </form>
                </div>
            </div>
        </div>
