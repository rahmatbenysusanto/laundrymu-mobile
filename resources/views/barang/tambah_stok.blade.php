...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            <a href="{{ route('listPembelianBarang') }}">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Tambah Stok</a></div>
...
<div class="page-content-wrapper">
    ...
    <div class="container pt-3">
        <div class="row">
            <div class="col-12">
                <div class="card p-2">
                    <form action="{{ route('prosesTambahStokBarang') }}" method="POST">
                        @csrf
                        ...
                        <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="submit">Tambah Stok</button>
                    </form>
                </div>
            </div>
        </div>
