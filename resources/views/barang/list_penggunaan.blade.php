...
<div class="header-area" id="headerArea">
    <div class="container">
        <div class="header-content header-style-three position-relative d-flex align-items-center justify-content-between">
            ...
            <div class="logo-wrapper"><a href="#" class="title-page">Daftar Penggunaan</a></div>
            <div class="user-profile-wrapper">
                <a href="{{ route('tambahPenggunaan') }}" class="text-black">
...
<div class="page-content-wrapper">
    ...
    <div class="mt-3"></div>
    <div class="container">
        <table class="w-100" id="listPenggunaan">
            <thead>
            <tr>
                <th></th>
            </tr>
...
<script>
    let table = $("#listPenggunaan").DataTable({
        paging: false,
        order: false
    });
